...
if(NOT provisioned AND HF_ENABLED)
    ...
    if(stamp_ok AND have_assets)
        ...
        if(HF_OK)
            ...
            # Remove empty files left by failed downloads (CMake creates file before downloading)
            foreach(asset ${ASSETS})
                if(EXISTS "${DIST_DIR}/${asset}")
                    file(SIZE "${DIST_DIR}/${asset}" sz)
                    if(sz EQUAL 0)
                        file(REMOVE "${DIST_DIR}/${asset}")
                    endif()
                endif()
            endforeach()
        endif()
